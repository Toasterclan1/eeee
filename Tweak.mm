...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.55];
...
- (void)setupUI {
    ...
    self.containerGradient.colors = @[
        (id)[[UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.98f] CGColor],
        (id)[[UIColor colorWithRed:0.93f green:0.93f blue:0.95f alpha:0.98f] CGColor]
    ];
    ...
    self.containerView.layer.borderColor = [[UIColor colorWithRed:0.75f green:0.75f blue:0.78f alpha:0.9f] CGColor];
...
- (void)layoutSubviewsInContainer:(CGFloat)containerH {
    ...
    [keyboardBtn setBackgroundColor:[UIColor colorWithRed:0.88f green:0.88f blue:0.92f alpha:1.0f]];
    ...
    titleLabel.text = @"insert name here";
    titleLabel.textColor = [UIColor colorWithRed:0.12f green:0.32f blue:0.72f alpha:1.0f];
    ...
    self.tabControl.backgroundColor = [UIColor colorWithRed:0.92f green:0.92f blue:0.94f alpha:1.0f];
    self.tabControl.selectedSegmentTintColor = [UIColor colorWithRed:0.2f green:0.48f blue:0.9f alpha:1.0f];
    NSDictionary *normalAttrs = @{ NSForegroundColorAttributeName: [UIColor colorWithWhite:0.35f alpha:1.0f] };
    NSDictionary *selectedAttrs = @{ NSForegroundColorAttributeName: [UIColor colorWithWhite:0.1f alpha:1.0f] };
    ...
    self.contentScrollView.backgroundColor = [UIColor colorWithRed:0.95f green:0.95f blue:0.97f alpha:0.6f];
...
- (void)loadItemsTab {
    ...
    spawnerCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
    ...
    spawnerTitle.textColor = [UIColor colorWithRed:0.45f green:0.15f blue:0.75f alpha:1.0f];
    ...
    searchField.backgroundColor = [UIColor colorWithRed:0.93f green:0.93f blue:0.95f alpha:1.0f];
    searchField.textColor = [UIColor colorWithWhite:0.1f alpha:1.0f];
    ...
    NSAttributedString *placeholder = [[NSAttributedString alloc] initWithString:@"Search..."
        attributes:@{ NSForegroundColorAttributeName: [UIColor colorWithWhite:0.55f alpha:1.0f] }];
    ...
    self.itemPicker.backgroundColor = [UIColor colorWithRed:0.94f green:0.94f blue:0.96f alpha:0.9f];
    ...
    qtyTitleLabel.textColor = [UIColor colorWithWhite:0.35f alpha:1.0f];
    ...
    self.quantityLabel.textColor = [UIColor colorWithWhite:0.1f alpha:1.0f];
    ...
    infoLabel.textColor = [UIColor colorWithWhite:0.4f alpha:1.0f];
    ...
    moneyCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
    ...
    cheatsCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
    ...
    shopCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
    ...
    communityCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
...
- (void)loadSettingsTab {
    ...
    presetCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
    ...
    presetTitle.textColor = [UIColor colorWithRed:0.45f green:0.15f blue:0.75f alpha:1.0f];
    ...
    presetPicker.backgroundColor = [UIColor colorWithRed:0.94f green:0.94f blue:0.96f alpha:0.9f];
    ...
    if (selectedPresetLocation == 0) {
        ...
        customCard.backgroundColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.95f];
        ...
        customTitle.textColor = [UIColor colorWithRed:0.85f green:0.4f blue:0.0f alpha:1.0f];
        ...
        useCustomLabel.textColor = [UIColor colorWithWhite:0.2f alpha:1.0f];
        ...
        for (int i = 0; i < 3; i++) {
            ...
            tf.backgroundColor = [UIColor colorWithRed:0.93f green:0.93f blue:0.95f alpha:1.0f];
            tf.textColor = [UIColor colorWithWhite:0.1f alpha:1.0f];
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    return [[NSAttributedString alloc] initWithString:title attributes:@{
        NSForegroundColorAttributeName: [UIColor colorWithWhite:0.1f alpha:1.0f],
...
static void createMenuButton(void) {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [menuButton setTitle:@"insert name here" forState:UIControlStateNormal];
        [menuButton setTitleColor:[UIColor colorWithRed:0.12f green:0.32f blue:0.72f alpha:1.0f] forState:UIControlStateNormal];
        menuButton.titleLabel.font = [UIFont systemFontOfSize:17.0f weight:UIFontWeightBold];

        CAGradientLayer *grad = [CAGradientLayer layer];
        grad.frame = menuButton.bounds;
        grad.colors = @[
            (id)[[UIColor colorWithRed:0.98f green:0.98f blue:1.0f alpha:1.0f] CGColor],
            (id)[[UIColor colorWithRed:0.88f green:0.90f blue:0.98f alpha:1.0f] CGColor]
        ];
        ...
        menuButton.layer.borderColor = [[UIColor colorWithWhite:0.6f alpha:0.8f] CGColor];
